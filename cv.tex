...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Developed and trained models for Intent classification, Entity recognition, Sentiment Analysis, Language Translation, POS tagging that are in par with the state-of-the-art models.  
		...
		\item My current work focuses on learning representations from non labelled datasets in unsupervised manner that generalizes well to any tasks when fine tuned upon.
	\end{itemize*}
...
\begin{itemize}
	...
	\begin{itemize*}
	    \textbullet Major in Computer Science  \hspace{20mm}
...
\begin{itemize}
	...
	\end{itemize*}
		...
		\item 
	\headerrow
		{\textbf{Language understanding by Unsupervised Bayesian Networks}}
			{\textbf{}}
	\\
	\headerrow
		{\emph{Train Bayesian NN in Unsupervised manner and fine-tune it in supervised fashion}}
		{\emph{}}
	\begin{itemize*}
	...
	\item 
	\headerrow
		{\textbf{Know your Intent: Semantic Hashing as Featurizer}}
			{\textbf{}}
	\\
	\headerrow
		{\emph{Semantic Hashing for Robust Text Classification with small data-sets}}
		{\emph{}}
	\begin{itemize*}
	...
	\end{itemize*}
		...
		\item 
	\headerrow
		{\textbf{Political Affiliation Prediction - Twitter}}
			{\textbf{}}
	\\
	\headerrow
