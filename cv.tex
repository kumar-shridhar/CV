...
\begin{description*}
	...
	Python, C, C++
	\item[Technologies:]
	PyTorch, Keras, TensorFlow, SciPy, NumPy, scikit-learn, NLTK, RASA, SpaCy, CoreNLP, UNIX, Git, \LaTeX
	\item[Natural Languages:]
	Native in English and Hindi, intermediate in German, beginner in Spanish	
