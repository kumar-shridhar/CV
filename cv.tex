...
\begin{itemize}
	...
	\end{itemize*}
		...
		\item 
	\headerrow
		{\textbf{Improving language understanding by Unsupervised Bayesian Networks}}
			{\textbf{}}
	\\
	\headerrow
		{\emph{Train Bayesian NN on Unsupervised datasets and fine-tune on supervised language task}}
		{\emph{}}
	\begin{itemize*}
		\item Posteriors learned over unsupervised training willbe used as priors when fine tuning. Model already should have a basic understanding of the task and can learn better approximations. Using same model to learn many language tasks (Sentiment Analysis, Classification and so on..)
	...
	\end{itemize*}
			...
			\item 
	\headerrow
		{\textbf{Semantic Hashing as Featurizer}}
			{\textbf{}}
	\\
	\headerrow
		...
		{\emph{}}
	\begin{itemize*}
		\item Using Semantic Hashing technique inspired from Deep Semantic Similarity model to overcome problems of out-of-vocabulary terms and spelling mistakes in small datasets for Intent Classification task. This work depends on using hash values rather than tokens as featurizers.
