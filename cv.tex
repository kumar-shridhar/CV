...
\begin{itemize}
	...
	\begin{itemize*}
		\item Developed a Natural Language Processing Framework from scratch in 40+ languages  \footnote{\url{https://developer.aylien.com/text-api-demo?tab=absa}} that powers all the customers chatbots at BotSupply\footnote{\url{https://developer.aylien.com/text-api-demo?tab=sentiment}}.
