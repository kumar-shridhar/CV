...
\begin{itemize}
	...
	\\
	\headerrow
		{\emph{Bayesian Convolutional Neural Network based on Bayes by Backprop in PyTorch} \footnote{\url{https://github.com/kumar-shridhar/PyTorch-BayesianCNN}}}
		{\emph{}}
	\begin{itemize*}
	...
	\\
	\headerrow
		{\emph{Superresolution using an efficient sub-pixel convolutional neural network in PyTorch} \footnote{\url{https://github.com/kumar-shridhar/super_resolution_PyTorch}}}
		{\emph{}}
	\begin{itemize*}
	...
	\\
	\headerrow
		{\emph{Predicting Political Affiliation of users based on Twitter Data (Tweets) in TensorFlow} \footnote{\url{https://github.com/kumar-shridhar/Twitter_Political_Party_Prediction}}}
		{\emph{}}
	\begin{itemize*}
